...
void AAITPlayerCharacter::NotifyControllerChanged()
{
...
void AAITPlayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AAITPlayerCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AAITPlayerCharacter::Look);
	}
	else
	{
...
void AAITPlayerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AAITPlayerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
