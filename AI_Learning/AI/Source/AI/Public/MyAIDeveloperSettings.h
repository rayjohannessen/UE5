...
#include "MyAIDeveloperSettings.generated.h"
...
class AI_API UMyAIDeveloperSettings : public UDeveloperSettingsBackedByCVars
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(Config, EditDefaultsOnly, Category = "Spawning")
	TMap<TSubclassOf<AAICharacter>, FAISpawnSettings> SpawnSettings;
